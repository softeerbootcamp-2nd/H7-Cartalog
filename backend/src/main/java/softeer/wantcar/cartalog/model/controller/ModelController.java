...
//                        new PowerTrainHMGDataDto("최고출력", 202f, "3,800", "PS/rpm"),
//                        new PowerTrainHMGDataDto("최대토크", 45.0f, "1,750~2,750", "kgf-m/rpm")))
//                .build();
//    }
//
...
//                .powerTrainHMGData(List.of(
//                        new PowerTrainHMGDataDto("최고출력", 295f, "6,000", "PS/rpm"),
//                        new PowerTrainHMGDataDto("최대토크", 36.2f, "5,200", "kgf-m/rpm")))
//                .build();
//    }
}
