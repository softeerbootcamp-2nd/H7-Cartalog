...
SELECT id,
       model_id,
       name,
       case when parent_category = 'NULL' then null else parent_category end as parent_category,
       child_category,
       image_url,
       description
...
INSERT INTO detail_model_decision_options (id, detail_model_id, model_option_id, price)
SELECT *
...
SELECT name, case when category = 'NULL' then null else category end as category
...
INSERT INTO colors (id, name, image_url)
SELECT *
...
INSERT INTO model_exterior_colors (id, model_id, color_id, price)
SELECT *
...
INSERT INTO model_interior_colors (id, basic_model_id, name, price, image_url)
SELECT *
...
INSERT INTO trim_interior_colors (id, model_interior_color_id, trim_exterior_color_id)
SELECT *
